...
class PalmScoreAll extends StatefulWidget {
  final String userId;
  ...
  @override
  State<PalmScoreAll> createState() => _PalmScoreAllState();
}

class _PalmScoreAllState extends State<PalmScoreAll> {
